...
namespace AcademicosUem.Controllers
{
    public class DocentesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,apelido,nome,seccao")] Docente docente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,apelido,nome,seccao")] Docente docente)
        {
            if (ModelState.IsValid)
            {
